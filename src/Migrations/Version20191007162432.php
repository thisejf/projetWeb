 ...
 */
final class Version20191007162432 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE commune (id INT AUTO_INCREMENT NOT NULL, commune VARCHAR(10) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE abus (id INT AUTO_INCREMENT NOT NULL, internaute_id INT DEFAULT NULL, commentaire_id INT DEFAULT NULL, description VARCHAR(10) DEFAULT NULL, encodage DATETIME DEFAULT NULL, INDEX IDX_72C9FD01CAF41882 (internaute_id), INDEX IDX_72C9FD01BA9CD190 (commentaire_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE news_letter (id INT AUTO_INCREMENT NOT NULL, document_pdf VARCHAR(10) DEFAULT NULL, publication DATETIME DEFAULT NULL, titre VARCHAR(10) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE utilisateur (id INT AUTO_INCREMENT NOT NULL, code_postal_id INT DEFAULT NULL, localite_id INT DEFAULT NULL, commune_id INT DEFAULT NULL, adresse_numero VARCHAR(10) DEFAULT NULL, adresse_rue VARCHAR(10) DEFAULT NULL, banni TINYINT(1) DEFAULT NULL, e_mail VARCHAR(10) DEFAULT NULL, inscription_conf TINYINT(1) DEFAULT NULL, inscription DATETIME DEFAULT NULL, mot_de_passe VARCHAR(10) DEFAULT NULL, nb_essais_infructueux INT DEFAULT NULL, type_utilisateur VARCHAR(10) DEFAULT NULL, discr VARCHAR(255) NOT NULL, INDEX IDX_1D1C63B3B2B59251 (code_postal_id), INDEX IDX_1D1C63B3924DD2B5 (localite_id), INDEX IDX_1D1C63B3131A4F72 (commune_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE commentaire (id INT AUTO_INCREMENT NOT NULL, internaute_id INT DEFAULT NULL, prestataire_id INT DEFAULT NULL, contenu VARCHAR(10) DEFAULT NULL, cote INT DEFAULT NULL, encodage INT DEFAULT NULL, titre VARCHAR(10) DEFAULT NULL, INDEX IDX_67F068BCCAF41882 (internaute_id), INDEX IDX_67F068BCBE3DB2B7 (prestataire_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE promotion (id INT AUTO_INCREMENT NOT NULL, prestataire_id INT DEFAULT NULL, categorie_de_services_id INT DEFAULT NULL, affichage_de DATETIME DEFAULT NULL, affichage_jusque DATETIME DEFAULT NULL, debut DATETIME DEFAULT NULL, description VARCHAR(10) DEFAULT NULL, document_pdf VARCHAR(10) DEFAULT NULL, fin DATETIME DEFAULT NULL, nom VARCHAR(10) DEFAULT NULL, INDEX IDX_C11D7DD1BE3DB2B7 (prestataire_id), INDEX IDX_C11D7DD14A81A587 (categorie_de_services_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE categorie_de_services (id INT AUTO_INCREMENT NOT NULL, description VARCHAR(10) DEFAULT NULL, en_avant TINYINT(1) DEFAULT NULL, nom VARCHAR(10) DEFAULT NULL, valide TINYINT(1) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE bloc (id INT AUTO_INCREMENT NOT NULL, position_id INT DEFAULT NULL, description VARCHAR(10) DEFAULT NULL, nom VARCHAR(10) DEFAULT NULL, INDEX IDX_C778955ADD842E46 (position_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE localite (id INT AUTO_INCREMENT NOT NULL, localite VARCHAR(10) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE code_postal (id INT AUTO_INCREMENT NOT NULL, code_postal VARCHAR(10) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE prestataire (id INT NOT NULL, e_mail_contact VARCHAR(10) DEFAULT NULL, nom VARCHAR(10) DEFAULT NULL, num_tel VARCHAR(10) DEFAULT NULL, num_tva VARCHAR(10) DEFAULT NULL, site_internet VARCHAR(10) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE internaute (id INT NOT NULL, image_id INT DEFAULT NULL, position_id INT DEFAULT NULL, news_letter TINYINT(1) DEFAULT NULL, nom VARCHAR(10) DEFAULT NULL, prenom VARCHAR(10) DEFAULT NULL, UNIQUE INDEX UNIQ_6C8E97CC3DA5256D (image_id), INDEX IDX_6C8E97CCDD842E46 (position_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE stage (id INT AUTO_INCREMENT NOT NULL, prestataire_id INT DEFAULT NULL, affichage_de DATETIME DEFAULT NULL, affichage_jusque DATETIME DEFAULT NULL, debut DATETIME DEFAULT NULL, description VARCHAR(10) DEFAULT NULL, fin DATETIME DEFAULT NULL, info_complementaire VARCHAR(10) DEFAULT NULL, nom VARCHAR(10) DEFAULT NULL, tarif VARCHAR(10) DEFAULT NULL, INDEX IDX_C27C9369BE3DB2B7 (prestataire_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE images (id INT AUTO_INCREMENT NOT NULL, prestataire_id INT DEFAULT NULL, prestataire_photos_id INT DEFAULT NULL, categorie_de_services_id INT DEFAULT NULL, image VARCHAR(10) DEFAULT NULL, ordre INT DEFAULT NULL, INDEX IDX_E01FBE6ABE3DB2B7 (prestataire_id), INDEX IDX_E01FBE6ACAC938C2 (prestataire_photos_id), UNIQUE INDEX UNIQ_E01FBE6A4A81A587 (categorie_de_services_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
