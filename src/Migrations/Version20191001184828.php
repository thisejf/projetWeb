 ...
 */
final class Version20191001184828 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE bloc (id INT AUTO_INCREMENT NOT NULL, position_id INT DEFAULT NULL, description VARCHAR(10) DEFAULT NULL, identifiant INT DEFAULT NULL, nom VARCHAR(10) DEFAULT NULL, INDEX IDX_C778955ADD842E46 (position_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
